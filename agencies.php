            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="form-group row">
                            <h4 for="year" class="col-xs-2 col-form-label mr-2">Danh sách đại lý</h4>
                            <div class="col-xs-2">
                                <a href="#addSaleModal" class="btn btn-success d-flex align-items-center justify-content " data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Thêm đại lý</span></a>
                            </div>
                        </div>
                    </div>
        ...
        <div id="addSaleModal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form name="add_agency" method="POST" action="/psi/php_action/employeeSaleCreate.php" class="form-horizontal">
